...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row==1) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Delete Confrimation" message:@"Are you sure to delete it." preferredStyle:UIAlertControllerStyleAlert];
...
//        UIAlertController *alertView=[[UIAlertController alloc] initWithTitle:@"message" message:@"Are you sure to delete it" delegate:self cancelButtonTitle:@"yes" otherButtonTitles:@"no", nil];
//        alertView.tag=101;
//        [alertView show];
    }
    if (indexPath.row==2) {
...
- (void)alertView:(UIAlertController *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex NS_DEPRECATED_IOS(2_0, 9_0){
