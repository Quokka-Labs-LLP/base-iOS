...
extension UIView {
  ...
  private func hideToast(_ toast: UIView, fromTap: Bool) {
    ...
    UIView.animate(
      ...
      if let nextToast = self.queue.firstObject as? UIView, let duration = objc_getAssociatedObject(
        nextToast,
        &ToastKeys.duration
      ) as? NSNumber,
  ...
  public func toastViewForMessage (
    ...
    let wrapperHeight = max(
      messageRect.origin.y + messageRect.size.height + style.verticalPadding,
...
public enum ToastPosition {
  ...
  fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
    let topPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.csSafeAreaInsets
      .top
    let bottomPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview
      .csSafeAreaInsets.bottom
